...
export default function CollectorAccount({ stats }: Props) {
    ...
    const quickActions = [
        { icon: ClipboardList, label: 'My Reports', value: stats.reports, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-950/40', href: '/collector/reports' },
        { icon: Truck, label: 'Completed', value: stats.completed_routes, color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-50 dark:bg-emerald-950/40', href: '/collector/routes' },
    ];
        ...
        <>
            ...
            <div className="flex min-h-screen flex-col bg-neutral-50 dark:bg-neutral-950">
                ...
                <div className="text-center px-4">
                    ...
                    <span className="mt-2 inline-flex items-center rounded-full bg-emerald-100 px-3 py-0.5 text-xs font-semibold capitalize text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-400">Collector</span>
                </div>
